 ...
 * 左边侧边栏
 */
class HotFragmentLeftMenuAdapter(
    val items: List<HotFragmentLeftMenuItem>
) : RecyclerView.Adapter<HotFragmentLeftMenuAdapter.ViewHolder>() {

    // 点击监听器
    private var onItemClickListener: ((HotFragmentLeftMenuItem, Int) -> Unit)? = null
    ...
    fun getSelectedPositionItem(): HotFragmentLeftMenuItem {
    ...
    public fun setOnItemClickListener(listener: (HotFragmentLeftMenuItem, Int) -> Unit) {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: HotFragmentLeftMenuItem, isSelected: Boolean) {
