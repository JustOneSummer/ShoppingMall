...
class RecommendFragmentRightMenuAdapter(

) : RecyclerView.Adapter<RecommendFragmentRightMenuAdapter.ViewHolder>() {
    private var items: List<RecommendFragmentRightMenuItem> = emptyList()

    // 点击监听器
    private var onItemClickListener: ((RecommendFragmentRightMenuItem, Int) -> Unit)? = null
    ...
    public fun setOnItemClickListener(listener: (RecommendFragmentRightMenuItem, Int) -> Unit) {
    ...
    fun updateData(newItems: List<RecommendFragmentRightMenuItem>) {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: RecommendFragmentRightMenuItem) {
...
//                .circleCrop()                       // 圆形裁剪（可选）
    ...
    class ProductDiffCallback(
        private val oldList: List<RecommendFragmentRightMenuItem>,
        private val newList: List<RecommendFragmentRightMenuItem>
    ) : DiffUtil.Callback() {
